...
PSEUDO_TARGETS := install_tools skip_mac skip_windows use_self_signed_cert binaries_only
...
PLATFORMS_TO_BUILD := $(filter-out $(patsubst skip_%,%,$(call HAS_PSEUDO_TARGET,$(filter skip_%,$(PSEUDO_TARGETS)))),mac windows)

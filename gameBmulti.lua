function gameBmulti_load()
	...
	wallfixturesp1[0] = love.physics.newFixture(wallbodiesp1, love.physics.newPolygonShape( 164, 0, 164,672, 196,672, 196, 0), 1.0)
	wallfixturesp1[0]:setUserData("leftp1")
	wallfixturesp1[0]:setFriction(0.0001)
	
	wallfixturesp1[1] = love.physics.newFixture(wallbodiesp1, love.physics.newPolygonShape( 516,0, 516,672, 548,672, 548,0), 1.0)
	wallfixturesp1[1]:setUserData("rightp1")
	wallfixturesp1[1]:setCategory( 2 )
	wallfixturesp1[1]:setFriction(0.0001)
	
	wallfixturesp1[2] = love.physics.newFixture(wallbodiesp1, love.physics.newPolygonShape( 196,640, 196,672, 516,672, 516,640), 1.0)
	wallfixturesp1[2]:setUserData("groundp1")
	
	--WALLS P2--
	wallbodiesp2 = love.physics.newBody(world, 32, -64, "static")
	
	wallfixturesp2[0] = love.physics.newFixture(wallbodiesp2, love.physics.newPolygonShape( 484, 0, 484,672, 516,672, 516, 0), 1.0)
	wallfixturesp2[0]:setUserData("leftp2")
	wallfixturesp2[0]:setCategory( 3 )
	wallfixturesp2[0]:setFriction(0.0001)
	
	wallfixturesp2[1] = love.physics.newFixture(wallbodiesp2, love.physics.newPolygonShape( 836,0, 836,672, 868,672, 868,0), 1.0)
...
function gameBmulti_update(dt)
	...
	nextpiecerot = (nextpiecerot + nextpiecerotspeed*dt) % (math.pi*2)
	...
	elseif gamestate == "failedBmulti" then
		...
		if clearcheck then --RESULTS SCREEN INI!--
			...
			resultsfloorfixtures = love.physics.newFixture(resultsfloorbody, love.physics.newPolygonShape( 196,448, 196,480, 836,480, 836,448), 1.0)
			resultsfloorfixtures:setUserData("resultsfloor")
